...
class CommonHolder(itemView:View):RecyclerView.ViewHolder(itemView )
{
     ...
     *  设置提示符
     */
    fun setHintText(viewId: Int, text: CharSequence): CommonHolder {
        val view = getView<TextView>(viewId)
        view.hint = "" + text
        return this
    }
     ...
     * @return
     */
    fun setImagePath(viewId: Int, imageLoader: HolderImageLoader): CommonHolder {
        val iv = getView<ImageView>(viewId)
     ...
     * 设置View的Visibility
     */
    fun setViewVisibility(viewId: Int, visibility: Int): CommonHolder {
