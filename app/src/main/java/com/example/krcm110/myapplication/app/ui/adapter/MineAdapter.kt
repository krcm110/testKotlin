package com.example.krcm110.myapplication.app.ui.adapter
...
import com.example.krcm110.myapplication.com.view.recyclerview.CommonHolder
import com.example.krcm110.myapplication.com.view.recyclerview.adapter.CommonAdapter
import com.example.krcm110.myapplication.R
import com.example.krcm110.myapplication.app.durationFormat
import com.example.krcm110.myapplication.com.glide.GlideApp
import io.reactivex.Observable

class MineAdapter(context :Context,arrayList: ArrayList<HomeBean.Issue.Item>) : CommonAdapter<HomeBean.Issue.Item>(context, arrayList, -1)
{
     ...
     * 绑定布局
     */
    override fun bindData(holder: CommonHolder, data: HomeBean.Issue.Item, position: Int) {
     ...
     * 加载 content item
     */
    private fun setVideoItem(holder: CommonHolder, item: HomeBean.Issue.Item) {
